...
const isHighlighted = computed(()=>{
  if (!gameStore.settings.showBasicStrategy) return
  return gameStore.basicStrategyMove === props.action
})

const doAction = computed(()=>{
  if (props.isEnabled) gameStore[props.action]({})
})
</script>
